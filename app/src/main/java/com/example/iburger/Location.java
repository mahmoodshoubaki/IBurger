...
public class Location extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setCheckedItem(menu.findItem(R.id.location));
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.profile:
                ...
                break;
            case R.id.burger:
                startActivity(new Intent(Location.this, Burger.class));
                finish();
                break;
            case R.id.snacks:
                startActivity(new Intent(Location.this, Snacks.class));
                finish();
                break;
            case R.id.orders:
                startActivity(new Intent(Location.this, Orders.class));
                finish();
                break;
